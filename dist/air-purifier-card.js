        ...
        <div class="row">
          ...
          <div class="body">
            <div class="head">
              ...
              <div class="pct ${$t({off:!n})}">
                ${n?a>0?`${a}%`:"On":"Off"}
              </div>
              <button class="power ${$t({on:n})}" title="Toggle" @click=${this._toggle}>
